...
class StarburstCollibraFacade(object):
    ...
    def __init__(self, collibra_url = None, collibra_user = None, collibra_pwd = None, tmp_dir = None):
    ...
    def query_and_import_data_products(self, galaxy_service, community = None, system_id = None):
        ...
        print ('INFO:  Pulling all data products from Starburst Galaxy')
        get_data_products_response = galaxy_service.get_data_products()
